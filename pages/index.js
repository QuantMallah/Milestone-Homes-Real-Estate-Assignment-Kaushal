    ...
    <>
      ...
      <div className='px-[10rem] py-[4rem] bg-slate-100'>
        ...
        <div className='flex items-center justify-evenly bg-white my-5 py-3'>
          ...
          <div>
            <button className="inline-flex items-center border border-[#eebc1d] bg-[#eebc1d] text-[white] font-semibold py-3 px-5 focus:outline-none rounded text-base mt-4 mx-2 hover:bg-[#e9e9f3] hover:text-[#eebc1d]">Search
            </button>
          </div>
        </div>
